...
The core CI runs a rigorous equivalence test on every commit: random witnesses and blocks produced by the closed-source encoder must verify identically through both the core's internal verifier and this public crate. Any divergence fails the build.

Licence
This verifier implementation is open-source and licensed under the MIT License. See the LICENSE file for details.

(Note: The core TAU compression engine, encoder, and DMA structures remain strictly proprietary and are distributed separately).
